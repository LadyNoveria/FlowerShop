...
public class EditOrderMenu implements Printable {
    /// Open-closed principle
    List<Command> listItems = getMenu();

    private List<Command> getMenu() {
        List<Command> list = new ArrayList<>();
        list.add(() -> System.out.println("1. Удалить пункт заказа"));
        list.add(() -> System.out.println("2. Редактировать количество товара"));
